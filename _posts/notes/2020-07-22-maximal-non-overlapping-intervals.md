...
[^4]: I have asserted this so that there is at least one maximally covering set of disjoint intervals from $$I$$, as this simplifies the formulations of both the problem and the algorithm.
