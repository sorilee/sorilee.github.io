...
*I thanks colleague J. Yim for careful reading and correcting that the complexity is $$O(S + \lvert I \rvert)$$ instead of $$O(\lvert I \rvert)$$, and colleague H. Noh for the problem and discussions.*
